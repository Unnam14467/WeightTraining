...
```{r conversion}
pml_training <- read.csv("C:/Users/uc14467/Desktop/Coursera/ML/pml-training.csv")
pml_testing <- read.csv("C:/Users/uc14467/Desktop/Coursera/ML/pml-testing.csv")
for(i in 7:159)
{
...
Model <- randomForest(formula,data=New_Training)
```
